...
swap1 = Swap.create(giver: winter.id, receiver: elisa.id, gift_id: gift4.id, event_id: first_event.id)
swap2 = Swap.create(giver: elisa.id, receiver: brian.id,  gift_id: gift3.id, event_id: first_event.id)
swap3 = Swap.create(giver: winter.id, receiver: brian.id,  gift_id: gift2.id, event_id: second_event.id)
swap4 = Swap.create(giver: brian.id, receiver: elisa.id,  gift_id: gift1.id, event_id: second_event.id)
